...
function changeDescription(img) {
    ...
    if (src.indexOf("0") > -1) {
        text = "<b>Лес называют</b> зелёным океаном земли, бесценным даром природы. Лес — настоящие легкие нашей планеты: он помогает дышать всему живому, выделяя кислород, очищая воздух от грязи, пыли и вредных для здоровья людей веществ."
    } else if (src.indexOf("1") > -1) {
        text = "<b>Лесные деревья</b> и кустарники выделяют особые оздоровительные вещества — фитонциды. Легко дышится в хвойных лесах, но и горьковатый запах белых кистей цветущей черемухи, и смолистый запах лопающихся почек осины — все это фитонциды, убивающие микроорганизмы."
    } else if (src.indexOf("2") > -1) {
        text = "<b>Леса кормят</b>, обогревают, дают материал для строительства. Плоды, цветы, листья, ветки и корни — источник пищи для животных. Мощные деревья с густой кроной служат хорошей защитой от транспортных шумов, сильных ветров. Леса сберегают воду и почву. Летом смягчают жару, зимой — холод."
    } else if (src.indexOf("3") > -1) {
        text = "<b>Лес издавна</b> служит людям: из древесины изготовляют почти 20000 видов продуктов и изделий. Сочетания лесных растений образуют пейзажи неповторимой красоты."
    } else if (src.indexOf("4") > -1) {
        text = "<b>Болото -</b> это сообщество многолетних растений, которые способны произрастать в условиях обильного увлажнения проточными или стоячими водами. В болотной почве содержится мало кислорода, а нередко и питательных веществ (минеральных солей), которые необходимы растениям."
    } else if (src.indexOf("5") > -1) {
        text = "<b>На лугу</b>, в лесу, по берегам рек и озер, вдоль дороги нередко попадаются участки с повышенным содержанием воды в почве. Здесь также поселяются растения, приспособленные к жизни в условиях переувлажнения."
    }
...
document.addEventListener("DOMContentLoaded", function(event) { 
    ...
    document.getElementById("clock").addEventListener("mouseover", function() {
        ...
        var timeText = "До Нового Года осталось: " + timeLeft.days + " дней " + timeLeft.hours + " часов " + timeLeft.minutes + " минут"
        this.title = timeText;
